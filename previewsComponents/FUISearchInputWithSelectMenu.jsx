                            ...
                            <li id="li-alert" className="hidden px-3 py-2 text-center text-gray-600">Not results available</li>
                            {
                                menuItems.map((el, idx) => (
                                    <li
                                        ...
                                        className={`${selectedItem.idx == idx ? 'text-yellow-600 bg-yellow-50' : ''} menu-el-js flex items-center justify-between px-3 py-2 cursor-default duration-150 text-gray-500 hover:text-yellow-600 hover:bg-yellow-50`}
                                    >
                                        {el}
                                        {
