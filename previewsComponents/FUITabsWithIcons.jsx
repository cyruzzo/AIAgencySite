...
export default function FUITabsWithIcons() {
  const tabItems = [
    {
      icon: (
        <svg
      ...
      >
        {tabItems.map((item, idx) => (
          <Tabs.Trigger
            ...
            value={item.name}
          >
            <div className="flex items-center gap-x-2 py-1.5 px-3 rounded-lg duration-150 group-hover:text-yellow-600 group-hover:bg-gray-50 group-active:bg-gray-100 font-medium">
              {item.icon}
              {item.name}
            </div>
          </Tabs.Trigger>
