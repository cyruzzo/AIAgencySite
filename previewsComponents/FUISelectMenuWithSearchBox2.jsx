...
export default function FUISelectMenuWithSearchBox2() {
  ...
  ({ children, className, ...props }, forwardedRef) => {
    ...
    return (
      <Select.Item
        className="flex items-center justify-between px-3 cursor-default py-2 duration-150 text-gray-600 data-[state=checked]:text-yellow-600 data-[state=checked]:bg-yellow-50 data-[highlighted]:text-yellow-600 data-[highlighted]:bg-yellow-50 data-[highlighted]:hover:text-yellow-600 data-[highlighted]:hover:bg-yellow-50 outline-none"
        {...props}
        ref={forwardedRef}
      >
        <Select.ItemText>
    ...
    <div className="m-6">
      ...
      >
        <div className="w-72 max-w-full mx-auto">
          <Select.Trigger className="w-full inline-flex items-center justify-between px-3 py-2 text-sm text-gray-600 bg-white border rounded-lg shadow-sm outline-none focus:ring-offset-2 focus:ring-yellow-600 focus:ring-2">
