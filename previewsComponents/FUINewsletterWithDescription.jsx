            ...
            <div className="max-w-screen-xl mx-auto px-4 justify-between items-center gap-12 md:px-8 md:flex">
                ...
                <div className="mt-6 md:mt-0">
                    <form onSubmit={(e) => e.preventDefault()} className="items-center gap-x-3 space-y-3 sm:space-y-0 md:space-y-3 sm:flex md:block">
                        ...
                        <button className="block w-full py-3 px-4 font-medium text-sm text-center text-white bg-yellow-600 hover:bg-yellow-500 active:bg-yellow-700 active:shadow-none rounded-lg shadow sm:w-auto md:w-full">
                            Subscribe
                        </button>
                    </form>
                </div>
