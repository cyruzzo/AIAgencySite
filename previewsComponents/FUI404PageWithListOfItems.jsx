...
export default function FUI404PageWithListOfItems() {
                        ...
                        <ul className="divide-y">
                            {
                                navigations.map((item, idx) => (
                                    <li key={idx} className="flex gap-x-4 py-6">
                                        <div className="flex-none w-14 h-14 bg-yellow-50 rounded-full text-yellow-600 flex items-center justify-center">
                                            {item.icon}
                                        </div>
