        ...
        <section className="py-14">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="max-w-3xl mx-auto text-center">
                    <h3 className="text-yellow-600 font-semibold pb-6">What people are saying</h3>
                    <ul>
                        {
                    ...
                    <ul className="flex gap-x-3 justify-center">
                        {
                            testimonials.map((item, idx) => (
                                <li key={idx}>
                                    <button className={`w-2.5 h-2.5 rounded-full duration-150 ring-offset-2 ring-yellow-600 focus:ring ${currentTestimonial == idx ? "bg-yellow-600" : "bg-gray-300"}`}
