    ...
    <section className="custom-screen mt-20">
      <div className="relative z-10 max-w-2xl mx-auto space-y-4 text-center">
        <h1 className="text-5xl heading my-7 py-7">
          <b className="bg-indigo-500 heading">Data Analysis Agents </b>
          to Empower Your Business
        </h1>
        <p className="text-zinc-400 py-7 my-7">
          Follow the line of Data Analysis Agents that will help you automate your workflow
        </p>
        <div className="flex flex-wrap items-center justify-center gap-3">
          <LinkItem href="https://datastripes.com" variant="shiny" className="inline-block w-full hover:bg-zinc-700 sm:w-auto">
